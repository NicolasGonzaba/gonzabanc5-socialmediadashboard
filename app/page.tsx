...
export default function Home() {
  ...
  return (
    <div className="flex flex-col flex-1 h-full items-center  bg-zinc-50 font-sans dark:bg-black ">
      ...
      <MainCard mediaName="@nathanf" mediaIcon={facebook} followerCount="1987" followerArrow={up} followerChange='12' fontColor="lime-green" mainClass="max-w-lg w-80 md:w-100 md:h-60 text-center m-4 light-gray  border-t-5 Facebook"></MainCard>
      ...
      {/* <div className="bg-red-500 dark:bg-blue-500 text-white p-6">
  DARK MODE TEST
</div> */}
      <div className="flex flex-col max-w-full md:flex-row">
      ...
      <h1 className="text-3xl mb-4">Social Media Dashboard</h1>
      <ThemeToggle />

      <div className="mt-6 w-80 card text-black dark:text-white">
        Card example with background variable
      </div>
    </div> */}
    </div>
